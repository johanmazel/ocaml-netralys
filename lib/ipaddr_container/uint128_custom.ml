...
let of_int32s a b c d =    
  ...
  { hi = Uint64.of_int64 int64_hi; lo = Uint64.of_int64 int64_lo }
  
let to_int32s x =
  let a = Uint64.to_int64 x.hi in
  let b = Uint64.to_int64 x.lo in
...
let of_int64s x y =
  { hi = Uint64.of_int64 x; lo = Uint64.of_int64 y }
  
let to_int64s x =
  Uint64.to_int64 x.hi, Uint64.to_int64 x.lo
